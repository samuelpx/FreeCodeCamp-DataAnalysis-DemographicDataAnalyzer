...
def calculate_demographic_data(print_data=True):
    ...
    average_age_men = round(df[df["sex"]=='Male'].age.sum() / df[df["sex"]=='Male'].sex.value_counts(), 1)

    # What is the percentage of people who have a Bachelor's degree?
    percentage_bachelors = round((df[df['education'] == 'Bachelors'].education.value_counts() / len(df)) * 100,1)
    ...
    highest_earning_country = teste.sort_values(ascending=False) 
    highest_earning_country_percentage = round((highest_earning_country[0] *100),1)
    highest_earning_country = highest_earning_country.index[0]

    # Identify the most popular occupation for those who earn >50K in India.
    top_IN_occupation = df[(df['native-country'] == 'India') & (df['salary'] == '>50K')].occupation.describe()[2]
